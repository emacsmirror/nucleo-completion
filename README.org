...
appended after scored matches in their original order.  The same threshold also
skips regexp expanders and match highlighting for those long candidates, while
the built-in fuzzy subsequence matcher still filters them.
